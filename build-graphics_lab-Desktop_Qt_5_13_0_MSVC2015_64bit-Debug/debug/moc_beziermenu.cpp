...
QT_MOC_LITERAL(5, 84, 23), // "receiveHoverCoordinates"
QT_MOC_LITERAL(6, 108, 1), // "x"
QT_MOC_LITERAL(7, 110, 1), // "y"
QT_MOC_LITERAL(8, 112, 23), // "receiveClickCoordinates"
QT_MOC_LITERAL(9, 136, 31), // "onPushControlPointButtonClicked"
QT_MOC_LITERAL(10, 168, 33), // "onClearControlPointsButtonCli..."
QT_MOC_LITERAL(11, 202, 29) // "onDrawBezierFullButtonClicked"

    },
    "BezierMenu\0sendDrawBezierFullSignal\0"
    "\0std::vector<std::pair<int,int> >\0"
    "controlPoints\0receiveHoverCoordinates\0"
    "x\0y\0receiveClickCoordinates\0"
    "onPushControlPointButtonClicked\0"
    "onClearControlPointsButtonClicked\0"
    "onDrawBezierFullButtonClicked"
};
...
void BezierMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->receiveHoverCoordinates((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->receiveClickCoordinates((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->onPushControlPointButtonClicked(); break;
        case 4: _t->onClearControlPointsButtonClicked(); break;
        case 5: _t->onDrawBezierFullButtonClicked(); break;
        default: ;
        }
